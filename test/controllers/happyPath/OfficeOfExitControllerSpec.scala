...
import models.{NormalMode, OfficeOfExit, UserAnswers}
  ...
  "OfficeOfExit Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      running(application) {
        ...
        status(result) mustEqual OK
        contentAsString(result) mustEqual view(form.fill(OfficeOfExit.values.head), NormalMode)(request, messages(application)).toString
      }
    }
