...
class DiscrepancyReferenceControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val discrepancyReferenceRoute: String = unhappyRoute.DiscrepancyReferenceController.onPageLoad(NormalMode).url
  ...
  "DiscrepancyReference Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, discrepancyReferenceRoute)
