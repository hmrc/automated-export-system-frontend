...
import uk.gov.hmrc.automatedexportsystemfrontend.forms.unhappyPath.DiscrepancySealsFormProvider
...
import uk.gov.hmrc.automatedexportsystemfrontend.pages.unhappyPath.DiscrepancySealsPage
import uk.gov.hmrc.automatedexportsystemfrontend.repositories.SessionRepository
import uk.gov.hmrc.automatedexportsystemfrontend.views.html.unhappyPath.DiscrepancySealsView
...
class DiscrepancySealsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val discrepancySealsRoute: String = unhappyRoute.DiscrepancySealsController.onPageLoad(NormalMode).url
