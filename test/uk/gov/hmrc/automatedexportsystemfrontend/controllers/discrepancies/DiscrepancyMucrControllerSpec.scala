...
import uk.gov.hmrc.automatedexportsystemfrontend.forms.discrepancies.DiscrepancyMucrFormProvider
...
import uk.gov.hmrc.automatedexportsystemfrontend.views.html.discrepancies.DiscrepancyMucrView
...
class DiscrepancyMucrControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val discrepancyMucrRoute: String = discrepanciesRoute.DiscrepancyMucrController.onPageLoad(NormalMode).url
