...
import uk.gov.hmrc.automatedexportsystemfrontend.forms.discrepancies.DiscrepancySealsFormProvider
...
import uk.gov.hmrc.automatedexportsystemfrontend.pages.discrepancies.DiscrepancySealsPage
import uk.gov.hmrc.automatedexportsystemfrontend.repositories.SessionRepository
import uk.gov.hmrc.automatedexportsystemfrontend.views.html.discrepancies.DiscrepancySealsView

import scala.concurrent.Future

class DiscrepancySealsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val discrepancySealsRoute: String = discrepanciesRoute.DiscrepancySealsController.onPageLoad(NormalMode).url
  ...
  "DiscrepancySeals Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, discrepancySealsRoute)
