...
import uk.gov.hmrc.automatedexportsystemfrontend.views.html.create.LocationTypeView
...
class LocationTypeControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val locationTypeRoute: String = createRoute.LocationTypeController.onPageLoad(NormalMode).url
