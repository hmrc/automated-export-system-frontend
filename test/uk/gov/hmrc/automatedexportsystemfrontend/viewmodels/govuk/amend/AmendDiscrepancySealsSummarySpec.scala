...
import uk.gov.hmrc.automatedexportsystemfrontend.viewmodels.checkAnswers.Amend.AmendDiscrepancySealsSummary
import uk.gov.hmrc.automatedexportsystemfrontend.viewmodels.govuk.all.*

class AmendDiscrepancySealsSummarySpec extends AnyFreeSpec with Matchers {
  ...
  "row" - {
    "when answered, return the summary row with change links" in {
      ...
      AmendDiscrepancySealsSummary.row(userAnswers, "submissionId", true) shouldBe Some(
