...
package uk.gov.hmrc.automatedexportsystemfrontend.govuk
...
import uk.gov.hmrc.automatedexportsystemfrontend.viewmodels.govuk.date.DateViewModel
import uk.gov.hmrc.automatedexportsystemfrontend.viewmodels.govuk.fieldset.{FieldsetViewModel, LegendViewModel}
...
class DateFluencySpec extends AnyFreeSpec with Matchers with Mappings with OptionValues {
  ...
  ".apply" - {
    ...
    val fieldset = FieldsetViewModel(LegendViewModel(Text("foo")))
