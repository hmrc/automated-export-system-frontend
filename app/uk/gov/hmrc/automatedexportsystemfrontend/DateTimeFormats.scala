...
package uk.gov.hmrc.automatedexportsystemfrontend
...
object DateTimeFormats {
  ...
  private val localisedDateTimeFormatters = Map("en" -> dateTimeFormatter, "cy" -> dateTimeFormatter.withLocale(new Locale("cy")))
